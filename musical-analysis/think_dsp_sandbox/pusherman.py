...
pusherman_wave_segment = pusherman_wave.segment(0, 30)  # also trims wave from 0 to 30
...
# plt.show()
#
amplitudes, frequencies = SpectrumHelper.get_spectrum_peaks_from(pusherman_wave, 0, 30, 0, 30)
